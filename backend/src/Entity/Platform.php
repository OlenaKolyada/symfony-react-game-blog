...
{
    use AutoSlugTrait;
    public const string GROUP_GET_PLATFORM = 'getPlatform';
    public const string GROUP_GET_PLATFORM_COLLECTION = 'getPlatformCollection';
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column(type: Types::INTEGER)]
    #[Groups([
        self::GROUP_GET_PLATFORM,
        self::GROUP_GET_PLATFORM_COLLECTION,
        Game::GROUP_GET_GAME
    ])]
    private ?int $id = null;
    ...
    #[Groups([self::GROUP_GET_PLATFORM])]
